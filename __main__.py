...
@click.option('-s', '--scantime', default='10', help='time in seconds to scan')
@click.option('-o', '--out', default='test.json', help='output cellphone data to file')
@click.option('-d', '--dictionary', default='oui.txt', help='OUI dictionary')
@click.option('-v', '--verbose', help='verbose mode', is_flag=False)
